...
export const HEAT_BUCKETS: HeatBucket[] = [
  { max: 5_000, color: '#165249', label: '< 5 mil' },
  { max: 10_000, color: '#1d685c', label: '5–10 mil' },
  { max: 25_000, color: '#257f6f', label: '10–25 mil' },
  { max: 50_000, color: '#2f9683', label: '25–50 mil' },
  { max: 150_000, color: '#3daf97', label: '50–150 mil' },
  { max: 500_000, color: '#55c8ab', label: '150–500 mil' },
  { max: Infinity, color: '#7ee3c5', label: '500 mil +' },
];
